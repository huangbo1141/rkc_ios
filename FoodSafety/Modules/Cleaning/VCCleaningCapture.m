...
#import "Language.h"
@interface VCCleaningCapture ()

@end

@implementation VCCleaningCapture
...
- (IBAction)acceptAction:(id)sender {
    [self serviceCleaningSave: true ];
    
}
- (IBAction)declineAction:(id)sender {
    [self serviceCleaningSave: false];
    
}

- (void) serviceCleaningSave:(BOOL) accept {
