//
//  TransportDepartureDetailView.m
//  FoodSafety
//
...
#import "TransportDepartureDetailView.h"
#import "UserInfo.h"
#import "Global.h"
#import <SDWebImage/UIImageView+WebCache.h>
@interface TransportDepartureDetailView ()

@end

@implementation TransportDepartureDetailView
...
- (void) initialize {
    ...
    if(logModel.mDepartureGoodFile != nil && [logModel.mDepartureGoodFile isKindOfClass:[NSString class]] && ![logModel.mDepartureGoodFile isEqualToString:@""]){
        [self.imgGood sd_setImageWithURL:[NSURL URLWithString:logModel.mDepartureGoodFile ]];
    }
}
